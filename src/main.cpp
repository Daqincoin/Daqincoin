...
// Copyright (c) 2013 The DAQINcoin developers
...
uint256 hashGenesisBlock("0x0000053147b3d7508a6cd1676a9de67cc7fa8ee6424761c5d6c99695c9cce32c");
static const unsigned int timeGenesisBlock = 1458284946;
...
const string strMessageMagic = "DAQINcoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "already in already databases we DAQINcoin from USA with reindexing.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x81cbeab547c16699ad040171ba67328fd9e38ec177de3c5419f036eddd568581"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DAQINcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DAQINcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DAQINcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("DAQINcoin-miner");
    ...
    try { loop {
        ...
        printf("Running DAQINcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("DAQINcoinMiner terminated\n");
        throw;
    }
}
