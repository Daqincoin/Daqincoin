...
const QString BITCOIN_IPC_PREFIX("DAQINcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click DAQINcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start DAQINcoin: click-to-pay handler");
    else
...
{
    // clicking on DAQINcoin: URLs creates FileOpen events on the Mac:
